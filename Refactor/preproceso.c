  ...
  if (widget == 0)
    {
      ...
      printf
	("Oops. Can't seem to create the entry box. Is the window too small?\n");
      exit (EXIT_FAILURE);
    }
...
int
entryPreProcessCB (EObjectType cdkType GCC_UNUSED, void *object,
		   void *clientData GCC_UNUSED, chtype input)
{
