...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/cdk_2

dist/Release/GNU-Linux-x86/cdk_2: ${OBJECTFILES}
...
${OBJECTDIR}/interfaz/login.o: nbproject/Makefile-${CND_CONF}.mk interfaz/login.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/interfaz/login.o interfaz/login.c
...
${OBJECTDIR}/interfaz/ventana.o: nbproject/Makefile-${CND_CONF}.mk interfaz/ventana.c 
	${MKDIR} -p ${OBJECTDIR}/interfaz
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/interfaz/ventana.o interfaz/ventana.c
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/cdk_2
