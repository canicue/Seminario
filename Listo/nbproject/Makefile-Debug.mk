...
LDLIBSOPTIONS=-L/usr/include/cdk -lcdk

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/listo

dist/Debug/GNU-Linux-x86/listo: ${OBJECTFILES}
...
${OBJECTDIR}/vista/principal.o: nbproject/Makefile-${CND_CONF}.mk vista/principal.c 
	${MKDIR} -p ${OBJECTDIR}/vista
	${RM} $@.d
	$(COMPILE.c) -g -I/usr/include/cdk -MMD -MP -MF $@.d -o ${OBJECTDIR}/vista/principal.o vista/principal.c
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/listo
